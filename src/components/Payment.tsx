...
const Payment = ({ amount, serviceName, onSuccess, onCancel }: PaymentProps) => {
  ...
  return (
    <div className="bg-white rounded-xl shadow-card p-6 md:p-8">
      <h2 className="text-2xl font-bold text-navy mb-6">Payment Details</h2>
      
      <div className="mb-6">
        <div className="flex items-center justify-between mb-2">
          <h3 className="font-medium text-navy">Order Summary</h3>
          <span className="text-navy/70">Booking ID: #BK{Math.floor(Math.random() * 10000)}</span>
        </div>
        <div className="bg-lightGray rounded-lg p-4">
          ...
          <div className="border-t border-navy/10 my-2 pt-2 flex justify-between">
            ...
            <span className="font-bold text-navy">{(amount * 1.19).toFixed(2)} TND</span>
          </div>
        </div>
      </div>
      ...
      <div className="mb-6">
        ...
        <div className="grid grid-cols-3 gap-3">
          <button
            ...
            className={`flex flex-col items-center justify-center p-4 rounded-lg border ${
              paymentMethod === 'card'
                ...
                : 'border-lightGray hover:border-gold/50'
            }`}
            onClick={() => setPaymentMethod('card')}
          >
            <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 mb-2 text-navy" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          >
            <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 mb-2 text-navy" viewBox="0 0 24 24" fill="currentColor">
      ...
      {paymentMethod === 'card' && (
        <form onSubmit={handleSubmit}>
          <div className="space-y-4">
            <div>
              <label htmlFor="cardNumber" className="block text-sm font-medium text-navy mb-1">
                Card Number
              </label>
              <input
                type="text"
            ...
            <div>
              <label htmlFor="cardName" className="block text-sm font-medium text-navy mb-1">
                Cardholder Name
              </label>
              <input
                type="text"
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                <label htmlFor="expiryDate" className="block text-sm font-medium text-navy mb-1">
                  Expiry Date
                </label>
                <input
                  type="text"
              ...
              <div>
                <label htmlFor="cvv" className="block text-sm font-medium text-navy mb-1">
                  CVV
                </label>
                <input
                  type="text"
      ...
      {paymentMethod === 'paypal' && (
        <div className="mt-6">
          <div className="bg-blue-50 p-4 rounded-lg text-center mb-4">
            <p className="text-navy mb-2">You'll be redirected to PayPal to complete your payment.</p>
            <p className="text-sm text-navy/70">Please make sure pop-ups are enabled in your browser.</p>
          </div>
          <button
      ...
      {paymentMethod === 'applepay' && (
        <div className="mt-6">
          <div className="bg-gray-50 p-4 rounded-lg text-center mb-4">
            <p className="text-navy mb-2">You'll complete your payment using Apple Pay.</p>
            <p className="text-sm text-navy/70">This option is only available on Apple devices with Apple Pay set up.</p>
          </div>
          <button
            onClick={handleSubmit}
